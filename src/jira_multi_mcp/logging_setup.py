...
``jira_multi_mcp``, ``httpx``, ``httpcore``, ``mcp``, and ``fastmcp`` Logger
...
_FILTER_OWNED_ATTR = "_jira_multi_mcp_owned_filter"
...
_REDACTED_LOGGER_NAMES: tuple[str, ...] = ("jira_multi_mcp", "httpx", "httpcore", "mcp", "fastmcp")
