...
- `JIRA_MULTI_TEST_SANDBOX_ISSUE=<KEY>` (a real, writable issue you own and
...
```bash
JIRA_MULTI_INTEGRATION=1 JIRA_MULTI_TEST_SANDBOX_ISSUE=<an issue you own> uv run pytest -m integration
```
